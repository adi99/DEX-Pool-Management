...
import iotx from '@/config/iotx.json';
...
const configs = { homestead, kovan, rinkeby, iotx };
...
configs.iotx = merge(registryIotx, configs.iotx);
const network = process.env.VUE_APP_NETWORK || 'iotx';
